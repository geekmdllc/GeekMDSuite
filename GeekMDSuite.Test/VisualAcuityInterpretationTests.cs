...
namespace GeekMDSuite.Test
{
    public class VisualAcuityInterpretationTests
    {
        ...
        {
            var classifcation = new VisualAcuityInterpretation(new VisualAcuity(15, 15, 15)).Classification;
        ...
        {
            var classifcation = new VisualAcuityInterpretation(new VisualAcuity(20, 20, 20)).Classification;
        ...
        {
            var classifcation = new VisualAcuityInterpretation(new VisualAcuity(200, 200, 200)).Classification;
        ...
        {
            var classifcation = new VisualAcuityInterpretation(new VisualAcuity(1500, 200, 200)).Classification;
