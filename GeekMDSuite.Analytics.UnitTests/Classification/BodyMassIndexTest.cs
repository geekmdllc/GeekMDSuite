...
namespace GeekMDSuite.Analytics.UnitTests.Classification
{
    public class BodyMassIndexTest
    {
        ...
        [InlineData(BodyMassIndexClassification.LowerLimits.UnderWeight - 1, Race.Asian, BodyMassIndex.SeverelyUnderweight)]
        ...
        [InlineData(BodyMassIndexClassification.LowerLimits.UnderWeight - 1, Race.BlackOrAfricanAmerican, BodyMassIndex.SeverelyUnderweight)]
        ...
        [InlineData(BodyMassIndexClassification.LowerLimits.ObeseClass1.NonAsian, Race.BlackOrAfricanAmerican, BodyMassIndex.ObesityClass1)]
        [InlineData(BodyMassIndexClassification.LowerLimits.ObeseClass2, Race.NativeHawaiianOrOtherPacificIslander, BodyMassIndex.ObesityClass2)]
        [InlineData(BodyMassIndexClassification.LowerLimits.ObeseClass3, Race.BlackOrAfricanAmerican, BodyMassIndex.ObesityClass3)]
