...
namespace GeekMDSuite.Analytics.UnitTests.Classification
{
    public class FunctionalMovementScreenInterpretationTests
    {
        ...
        public void Classification_Given1PainNegativeTrunkStability_ReturnsCorrectScoreAndRecommendedAction()
        {
            ...
            var trunkStabilityPushup =
                new FunctionalMovementScreenClassification(fms).Classification.TrunkStabilityPushup;
        ...
        public void Classification_GivenL3R1ActiveStraightLegRaise_ReturnsCorrectScoreAndRecommendedAction()
        {
            ...
            var activeStraightLegRaise =
                new FunctionalMovementScreenClassification(fms).Classification.ActiveStraightLegRaise;
        ...
        [Fact]
        public void
            Classification_GivenL3R1LPainNegativeLPainNegativeRotaryStability_ReturnsCorrectScoreAndRecommendedAction()
        {
            var fms = new FunctionalMovementScreenBuilder()
                .SetActiveStraightLegRaise(3, 3)
                .SetDeepSquat(3)
        ...
        [Fact]
        public void
            Classification_GivenL3R3LPainPositiveLPainNegativeRotaryStability_ReturnsCorrectScoreAndRecommendedAction()
        {
            var fms = new FunctionalMovementScreenBuilder()
                .SetActiveStraightLegRaise(3, 3)
                .SetDeepSquat(3)
