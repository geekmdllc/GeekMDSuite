...
namespace GeekMDSuite.Analytics.UnitTests.Classification
{
    public class PushupsInterpretationTests
    {
            ...
            GenderIdentity genderIdentity, int age, FitnessClassification expectedClassification)
        {
            ...
            var classification =
                new PushupsClassification(new MuscularStrengthClassificationParameters(pushups, _patient))
                    .Classification;
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                new PushupsClassification(new MuscularStrengthClassificationParameters(null,
