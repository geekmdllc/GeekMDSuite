...
namespace GeekMDSuite.Analytics.UnitTests.Classification
{
    ...
    {
        [Theory]
        [InlineData(PercentBodyFatClassification.LowerLimits.Male.Athletic - 1, GenderIdentity.Male, PercentBodyFat.UnderFat)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Male.Athletic, GenderIdentity.Male, PercentBodyFat.Athletic)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Male.Fit, GenderIdentity.Male, PercentBodyFat.Fitness)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Male.Acceptable, GenderIdentity.Male, PercentBodyFat.Acceptable)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Male.OverFat, GenderIdentity.Male, PercentBodyFat.OverFat)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Female.Athletic - 1, GenderIdentity.Female, PercentBodyFat.UnderFat)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Female.Athletic, GenderIdentity.Female, PercentBodyFat.Athletic)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Female.Fit, GenderIdentity.Female, PercentBodyFat.Fitness)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Female.Acceptable, GenderIdentity.Female, PercentBodyFat.Acceptable)]
        [InlineData(PercentBodyFatClassification.LowerLimits.Female.OverFat, GenderIdentity.Female, PercentBodyFat.OverFat)]
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                new PercentBodyFatClassification(BodyCompositionExpandedBuilder.Initialize().BuildWithoutModelValidation(), null));
        }
