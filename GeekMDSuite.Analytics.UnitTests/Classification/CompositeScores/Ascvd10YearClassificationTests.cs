...
namespace GeekMDSuite.Analytics.UnitTests.Classification.CompositeScores
{
    public class Ascvd10YearClassificationTests
    {
        ...
        [Theory]
        [InlineData(GenderIdentity.Male, 110, 50, 170, 100, false, false, false, false, 55,
            AscvdStatinRecommendation.LikelyNotBeneficial)]
        [InlineData(GenderIdentity.Male, 110, 50, 200, 190, false, false, false, false, 55,
            AscvdStatinRecommendation.HighIntensity)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, false, false, false, true, 55,
            AscvdStatinRecommendation.HighIntensity)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, true, false, false, false, 55,
            AscvdStatinRecommendation.HighIntensity)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, false, false, false, false, 65,
            AscvdStatinRecommendation.ModerateToHighIntensity)]
        [InlineData(GenderIdentity.Male, 110, 60, 170, 50, false, false, false, true, 76,
            AscvdStatinRecommendation.ModerateIntensity)]
        [InlineData(GenderIdentity.Male, 110, 60, 170, 50, false, false, false, false, 76,
            AscvdStatinRecommendation.PossiblyBeneficial)]
        public void Classfication_GivenParams_ReturnsCorrectStatinRecommendation(GenderIdentity genderIdentity,
            int systolic,
        ...
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, false, false, false, true,
            AscvdRiskClassification.Borderline)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, true, false, false, false,
        ...
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, false, false, false, true, 55,
            AscvdAspirinRecommendation.InsufficientEvidenceLikelyNotBeneficial)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, true, false, false, false, 55,
            AscvdAspirinRecommendation.Beneficial)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, true, false, false, false, 65,
            AscvdAspirinRecommendation.BeneficialWithReservation)]
        [InlineData(GenderIdentity.Male, 120, 50, 213, 130, true, false, false, false, 70,
            AscvdAspirinRecommendation.InsufficientEvidenceLikelyBeneficial)]
        public void Classfication_GivenParams_ReturnsCorrectAscvdAspirinRecommendation(GenderIdentity genderIdentity,
            int systolic, double hdl, double totalCholesterol, double ldl,
            bool diabetic, bool antiHypertensive, bool smoker, bool ascvdPresent, int age,
            AscvdAspirinRecommendation expected)
        {
            _patient.Gender = Gender.Build(genderIdentity);
            _patient.DateOfBirth = SetDateOfBirthMinusYears(age);
        ...
        [Theory]
        [InlineData(GenderIdentity.Male, 110, 50, 170, 100, false, false, false, false,
        ...
        public void Classification_GivenParams_ReturnsCorrectStatinCandicacy(GenderIdentity genderIdentity,
            int systolic, double hdl, double totalCholesterol, double ldl,
