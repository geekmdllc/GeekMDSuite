...
namespace GeekMDSuite.WebAPI.DataAccess.Fake
{
    public static partial class FakeGeekMdSuiteContextBuilder
    {
        ...
        {
            var fmse = new FunctionalMovementScreenEntity(FunctionalMovementScreenBuilder.Initialize()
            ...
            var fmse2 = new FunctionalMovementScreenEntity(FunctionalMovementScreenBuilder.Initialize()
