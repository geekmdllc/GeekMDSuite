...
namespace GeekMDSuite.WebAPI.Presentation.Controllers.AnalyzablePatientDataControllers
{
    ...
    {
        public QualitativeLabsController(IUnitOfWork unitOfWork, IMapper mapper, IErrorService errorService) : base(
        ...
        private List<ResourceLink> GenerateGetByIdLinks(int id)
        {
            return new List<ResourceLink>
            {
                ...
                new ResourceLink
                {
                    ...
                    Href =
                        Url.Action<QualitativeLabsController>(a => a.Put(id, With.No<QualitativeLabsStubFromUser>())),
        ...
        private IEnumerable<QualitativeLabsResource> GenerateQualitativeLabsResources(
            IEnumerable<QualitativeLabEntity> entities)
        {
