...
namespace GeekMDSuite.WebAPI.Presentation.Controllers.AnalyzablePatientDataControllers
{
    ...
    public class BodyCompositionsController : VisitDataController
    {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                var entity = await UnitOfWork.BodyCompositions.FindById(id);
                var stub = Mapper.Map<BodyCompositionEntity, BodyCompositionStub>(entity);
                var resource = new BodyCompositionResource
                {
        ...
        public async Task<IActionResult> Post([FromBody] BodyCompositionStubFromUser stub)
        {
            try
            {
                var entity = Mapper.Map<BodyCompositionStubFromUser, BodyCompositionEntity>(stub);
                await UnitOfWork.BodyCompositions.Add(entity);
                await UnitOfWork.Complete();
                var url = Url.Action<BodyCompositionsController>(a => a.Post(stub));
            ...
            catch (ArgumentNullException)
            {
                var error = ErrorService.PayloadBuilder
                    ...
                    .HasInternalMessage(
                        "A null object was included in the request body and cannot be processed as an BodyComposition entity")
                    .TellsUser(
                        "The request to create a new BodyComposition entry was malformed and likely empty. Please retry.")
                    .Build();
                return BadRequest(error);
            }
            catch (EntityNotUniqeException)
            {
                var error = ErrorService.PayloadBuilder
                    ...
                    .TellsUser("The request to create a new BodyComposition entry was imporoperly formatted ")
                    .Build();
        ...
        public async Task<IActionResult> Put(int id, [FromBody] BodyCompositionStubFromUser stub)
        {
            ...
            {
                var entity = Mapper.Map<BodyCompositionStubFromUser, BodyCompositionEntity>(stub);
                await UnitOfWork.BodyCompositions.Update(entity);
                await UnitOfWork.Complete();
                return Ok(stub);
            }
            catch (RepositoryEntityNotFoundException)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                await UnitOfWork.BodyCompositions.Delete(id);
                await UnitOfWork.Complete();
                return NoContent();
            }
            catch (RepositoryEntityNotFoundException)
        ...
        private IEnumerable<BodyCompositionResource> GenerateBodyCompositionResources(IEnumerable<BodyCompositionEntity> entities)
        {
            ...
            var resources = stubs.Select(stub => new BodyCompositionResource
            {
                ...
                Links = new List<ResourceLink>
                {
                    new ResourceLink
                    {
                        Description = "Get this BodyComposition resource",
                        Href = Url.Action<BodyCompositionsController>(a => a.GetById(stub.Id)),
        ...
        private List<ResourceLink> GenerateGetByIdLinks(int id)
        {
            return new List<ResourceLink>
            {
                new ResourceLink
                {
                    Description = "Get BodyComposition resource by it's unique identifier.",
                    Href = Url.Action<BodyCompositionsController>(a => a.GetById(id)),
                    HtmlMethod = HtmlMethod.Get,
                    Relationship = UrlRelationship.Self
                },
                new ResourceLink
                {
                    Description = "Delete BodyComposition resource by it's unique identifier.",
                    Href = Url.Action<BodyCompositionsController>(a => a.Delete(id)),
                ...
                new ResourceLink
                {
                    Description = "Search for BodyCompositions resources with filters and pagination",
                    Href = Url.Action<BodyCompositionsController>(a => a.GetBySearch(With.No<EntityDataFindFilter>())),
                    HtmlMethod = HtmlMethod.Get,
                    Relationship = UrlRelationship.Search
                },
                new ResourceLink
                {
                    Description = "Add a new BodyComposition resource",
                    Href = Url.Action<BodyCompositionsController>(a => a.Post(With.No<BodyCompositionStubFromUser>())),
