...
namespace GeekMDSuite.Analytics.Classification
{
    ...
    {
        public SpirometryClassification(ISpirometry spirometry, IPatient patient, IBodyComposition bodyComposition)
        {
        ...
        private SpirometryClassificationResult ClassifySpirometryResults()
        {
            ...
            if (obstructivePattern)
                return preservedVitalCapacity ? GradeObstructionSeverity() : SpirometryClassificationResult.MixedPattern;
