...
namespace GeekMDSuite.Analytics.Interpretation
{
    public class BloodPressureInterpretation : IInterpretable
    {
        public BloodPressureInterpretation(IBloodPressure parameters)
        {
            ...
            _classification = new BloodPressureClassification(_parameters).Classification;
        }
        public InterpretationText InterpretationText => new InterpretationBuilder()
        ...
        private string BuildSummary()
        {
            ...
            return $"Your blood pressure is {bloodPressure.Systolic}/{bloodPressure.Diastolic} mmHg. " +
                   $"This is defined as {_classification}. " +
        ...
        private  InterpretationSection BuildMakingChangesSection()
        {
            ...
            if (_classification == BloodPressureStage.Low)
            ...
            if (_classification == BloodPressureStage.Elevated)
                return section.AddParagraph("Your blood pressure is elevated to a range that is most often addressable " +
                                            ...
                                            "remedy this.").Build();
            if (_classification == BloodPressureStage.Stage1Hypertension)
            ...
            if (_classification == BloodPressureStage.Stage2Hypertension)
            ...
            if (_classification == BloodPressureStage.HypertensiveUrgency)
            ...
            if (_classification == BloodPressureStage.HypertensiveEmergency)
        ...
        private readonly BloodPressureStage _classification;
    }
}