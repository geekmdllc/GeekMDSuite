...
namespace GeekMDSuite.Core.Analytics.Classification
{
    ...
    // 2013 ACC/AHA
    public class Ascvd10YearClassification : IClassifiable<AscvdClassificationResult>
    {
        public Ascvd10YearClassification(IPooledCohortEquationParameters equationParams, IQuantitativeLab ldlCholesterol, bool clinicialAscvdPresent = false)
        {
        ...
        private AscvdClassificationResult Classify() => 
            AscvdClassificationResult.Build(AscvdRisk(), StatinCandidacy(), StatinRecommendation(), AspirinCandidacy(), GetRiskFactors() );
