...
namespace GeekMDSuite.Analytics.Repositories
{
    internal static class GripStrengthRepository
    {
        ...
        public static GripStrengthLimits GetRanges(Patient patient)
        {
            _patient = patient;
        ...
        private static GripStrengthLimits MapFemaleLimits()
        {
            ...
            return InAgeRange(65, 69)
                ? GenerateGripStrengthLimits(15.4, 24.5)
