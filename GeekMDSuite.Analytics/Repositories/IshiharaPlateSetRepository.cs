...
namespace GeekMDSuite.Analytics.Repositories
{
    internal static class IshiharaPlateSetRepository
    {
        ...
        public static List<IshiharaPlateModel> SixPlateScreen()
        {
            return GetSet(IshiharaTestType.Ishihara6);
        }

        public static List<IshiharaPlateModel> FourteenPlateScreen()
        {
            return GetSet(IshiharaTestType.Ishihara14);
        }

        public static List<IshiharaPlateModel> TenPlateScreen()
        {
            throw new NotImplementedException(nameof(IshiharaPlateSetRepository));
        }

        public static List<IshiharaPlateModel> TwentyFourPlateScreen()
        {
            return GetSet(IshiharaTestType.Ishihara24);
        }

        public static List<IshiharaPlateModel> ThirtyEightPlateScreen()
        {
            return GetSet(IshiharaTestType.Ishihara38);
        }
        ...
        private static string ProtanDeutanDiffentiation(string protanStronger, string deutanStronger)
        {
            return string.Format(
                $"P: {protanStronger}/({deutanStronger}){protanStronger} D: {deutanStronger}/{deutanStronger}({protanStronger})");
        }
        ...
        private static void InitializeThirtyEightPlate(ICollection<IshiharaPlateModel> plates)
        {
            ...
            plates.Add(new IshiharaPlateModel(22, IshiharaPlateType.NumeralProtanDuetan, "26",
                ProtanDeutanDiffentiation("6", "2"),
                UnableToRead));
            plates.Add(new IshiharaPlateModel(23, IshiharaPlateType.NumeralProtanDuetan, "42",
                ProtanDeutanDiffentiation("2", "4"),
                UnableToRead));
            plates.Add(new IshiharaPlateModel(24, IshiharaPlateType.NumeralProtanDuetan, "35",
                ProtanDeutanDiffentiation("5", "3"),
                UnableToRead));
            plates.Add(new IshiharaPlateModel(25, IshiharaPlateType.NumeralProtanDuetan, "96",
                ProtanDeutanDiffentiation("6", "9"),
                UnableToRead));
            ...
            plates.Add(new IshiharaPlateModel(34, IshiharaPlateType.Traceable, TraceableBgyg, TraceableRgv,
                UnableToRead));
            plates.Add(new IshiharaPlateModel(35, IshiharaPlateType.Traceable, TraceableBgyg, TraceableBgv,
                UnableToRead));
            plates.Add(new IshiharaPlateModel(36, IshiharaPlateType.Traceable, TraceableVo, TraceableBgv,
                UnableToRead));
            plates.Add(new IshiharaPlateModel(37, IshiharaPlateType.Traceable, TraceableVo, TraceableBgv,
                UnableToRead));
        ...
        private static void InitializeTwentyFourPlate(ICollection<IshiharaPlateModel> plates)
        {
            ...
            plates.Add(new IshiharaPlateModel(16, IshiharaPlateType.NumeralProtanDuetan, "26",
                ProtanDeutanDiffentiation("6", "2"),
                UnableToRead));
            plates.Add(new IshiharaPlateModel(17, IshiharaPlateType.NumeralProtanDuetan, "42",
                ProtanDeutanDiffentiation("2", "4"),
                UnableToRead));
            ...
            plates.Add(new IshiharaPlateModel(20, IshiharaPlateType.Traceable, TraceableBgyg, UnableToRead,
                UnableToRead));
            plates.Add(new IshiharaPlateModel(21, IshiharaPlateType.Traceable, TraceableVo, TraceableBgv,
                UnableToRead));
            plates.Add(new IshiharaPlateModel(22, IshiharaPlateType.Traceable, TraceableBgyg, TraceableBgv,
                UnableToRead));
            plates.Add(new IshiharaPlateModel(23, IshiharaPlateType.Traceable, TraceableVo, TraceableBgv,
                UnableToRead));
        ...
        private static void InitializeFourteenPlate(ICollection<IshiharaPlateModel> plates)
        {
            ...
            plates.Add(new IshiharaPlateModel(12, IshiharaPlateType.NumeralProtanDuetan, "35",
                ProtanDeutanDiffentiation("5", "3"),
                UnableToRead));
            plates.Add(new IshiharaPlateModel(13, IshiharaPlateType.NumeralProtanDuetan, "96",
                ProtanDeutanDiffentiation("6", "9"),
                UnableToRead));
        ...
        private static void InitializeSixPlate(ICollection<IshiharaPlateModel> plates)
        {
            ...
            plates.Add(new IshiharaPlateModel(3, IshiharaPlateType.Numeral, "26", ProtanDeutanDiffentiation("6", "2"),
                UnableToRead));
